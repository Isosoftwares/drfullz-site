...
function RegisterSeller() {
  return (
    <div className="bg-slate-950 flex flex-col justify-center items-center min-h-screen bg-cover bg-center bg-no-repeat">
      <div className="w-[93%] md:w-[450px] bg-slate-900 border border-slate-800 text-start rounded-2xl shadow-2xl p-8 border-t-4 border-t-green-500">
        <h1 className="text-3xl font-bold text-white mb-6">Sign Up (Seller)</h1>

        <div className="bg-green-600/10 border border-green-600/20 text-green-400 p-6 flex flex-col gap-4 rounded-xl items-center">
          ...
          <div className="bg-slate-800 p-4 rounded-lg border border-slate-700 w-full text-center">
            ...
            <p className="text-lg font-bold text-white selection:bg-green-500 selection:text-slate-900">
